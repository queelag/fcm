...
export const ECE_AUTH_SECRET: Uint8Array<ArrayBuffer> = decodeBase64('PZChiwbgqaQ3cWT8vvqwMA==')
export const ECE_PRIVATE_KEY: Uint8Array<ArrayBuffer> = decodeBase64('jldkYXifY0biPzg0KC5R5jc/Wvh7i83sBDH/qpf0l74=')
export const ECE_PUBLIC_KEY: Uint8Array<ArrayBuffer> = decodeBase64('BD4QIR+mIsck16PMkbQmcfDo9J6/wwzwpeoirJ27U3EzKnW/aANwkpBPTZdkJS+y8r85vQ1zuhti+wTzdyW6f/s=')
